...
contract Panagram is ERC1155, Ownable {
    ...
    constructor(IVerifier _verifier)
        ERC1155("ipfs://bafybeihspf2semvjwfmwsetjhadmdhmdwp4fbpemdofvcywmwx4pbu6hfu/{id}.json")
        Ownable(msg.sender)
    {
    ...
    function contractURI() public pure returns (string memory) {
        return "ipfs://bafkreietg4bqp3d6zq26mfwkrh7adeneqdmcgfdurl3wu7n7brb6t5gko4";
    }
